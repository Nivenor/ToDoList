              ...
              <Menu.Positioner>
                <Menu.Content>
                  <MenuItemGroup>
                    ...
                    <Menu.Item
                      value='active'
                      onClick={() => handleSortUndone()}
                    >
                      Активные
                    </Menu.Item>
                    <Menu.Item value='done' onClick={() => handleSortDone()}>
                      Завершенные
                    </Menu.Item>
                    <Menu.Item value='all' onClick={() => handleSortAll()}>
                      Все
                    </Menu.Item>
                  </MenuItemGroup>
                </Menu.Content>
              ...
              <Menu.Positioner>
                <Menu.Content>
                  <MenuItemGroup>
                    ...
                    <Menu.Item
                      value='undone'
                      onClick={() => handleUndoneTasks()}
                    >
                      Активные
                    </Menu.Item>
                    <Menu.Item value='done' onClick={() => handleDoneTasks()}>
                      Завершенные
                    </Menu.Item>
                    <Menu.Item
                      value='newDate'
                      onClick={() => handleNewDateTasks()}
                    >
                      Новые
                    </Menu.Item>
                    <Menu.Item
                      value='oldDate'
                      onClick={() => handleOldDateTasks()}
                    >
                      Старые
                    </Menu.Item>
                  </MenuItemGroup>
      ...
      {showAlert && (
        <Alert.Root status='error' marginTop={8}>
          ...
          <Alert.Content>
            ...
            <Alert.Description>Поле не может быть пустым!</Alert.Description>
          </Alert.Content>
        </Alert.Root>
      )}
    </Box>
